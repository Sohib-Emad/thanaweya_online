...
class _StudentHomeScreenState extends State<StudentHomeScreen> {
  ...
  @override
  void dispose() { _searchController.dispose(); _coursesCubit.close(); super.dispose(); }
    ...
    return SingleChildScrollView(
      ...
      child: NotebookPaper(
        child: Column(
          ...
          children: [
            HomeMasthead(firstName: _firstName, onNotificationsTap: () => Navigator.pushNamed(context, AppRouter.notifications)),
